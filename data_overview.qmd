...
pacman::p_load(ggplot2,dplyr,ggridges,tidyr,purrr,lubridate,webr,flextable,kableExtra,toolPhD)
...
```{r,warning=FALSE,echo=FALSE, message=FALSE}
  cat(
  sprintf(
  "### %s traits across 6 years, 6 locations and 9 managements",nrow(long)),
  sep = "\n"
  ) 
```
...
second.ring <- list(c("228\nwinter wheat\ncultivars","year of release\n1960-2016","8710\nSNIPs"),
                    c("6 locations","soil map","Germany"),
                    c("2 phases","climatic\ndata",""),
...
## 6 Locations
[Fig1. Experiments location and soil properties.](./figure/fig1.png)
...
"```{r}",
"#| echo: false",
sprintf("#| fig-cap: %s-management", tr),
sprintf("#| label: fig-%s-mp", tr),
