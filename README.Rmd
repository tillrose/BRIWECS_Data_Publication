...
![](https://github.com/tillrose/BRIWECS_Data_Publication/blob/main/figure/Instruction.PNG){fig-align="center"}

***Note: Part of data the traits in Location KAL, PhaseII (2018-2020) is still under data-preparation, will be updated soon***
...
r.target <- paste(c(".git",".Rproj.user",".quarto","gfm","docs","figure"),
                  collapse='|')
